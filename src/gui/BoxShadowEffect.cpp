...
BoxShadowEffect::BoxShadowEffect(QObject* parent) :
...
void BoxShadowEffect::draw(QPainter* painter) {
...
QRectF BoxShadowEffect::boundingRectFor(const QRectF& rect) const {
